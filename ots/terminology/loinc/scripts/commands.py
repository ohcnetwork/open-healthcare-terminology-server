...
def load(ctx: typer.Context) -> None:
    ...
    raise typer.Exit(run_module_main("ots.terminology.loinc.scripts.load_loinc_postgres", ctx.args))
...
def cleanup_codes(ctx: typer.Context) -> None:
    ...
    raise typer.Exit(run_module_main("ots.terminology.loinc.scripts.cleanup_codes", ctx.args))
...
def cleanup_status(ctx: typer.Context) -> None:
    ...
    raise typer.Exit(run_module_main("ots.terminology.loinc.scripts.cleanup_status", ctx.args))
...
def rebuild_search_text(ctx: typer.Context) -> None:
    ...
    raise typer.Exit(run_module_main("ots.terminology.loinc.scripts.rebuild_search_text", ctx.args))
