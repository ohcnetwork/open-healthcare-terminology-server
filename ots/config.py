...
API_KEY_HEADER = (
    _env_str("OTS_API_KEY_HEADER", DEFAULT_API_KEY_HEADER) or DEFAULT_API_KEY_HEADER
).lower()
PUBLIC_PATHS = _env_csv("OTS_PUBLIC_PATHS", DEFAULT_PUBLIC_PATHS)

DATABASE_URL = (
    _env_str("OTS_DATABASE_URL", DEFAULT_DATABASE_URL) or DEFAULT_DATABASE_URL
)
...
TERMINOLOGY_KEY = (
    _env_str("OTS_TERMINOLOGY", DEFAULT_TERMINOLOGY_KEY) or DEFAULT_TERMINOLOGY_KEY
)
_EMBEDDING_DIMENSIONS_VALUE = _env_str("OTS_EMBEDDING_DIMENSIONS")
EMBEDDING_DIMENSIONS_OVERRIDE = (
    int(_EMBEDDING_DIMENSIONS_VALUE)
    if _EMBEDDING_DIMENSIONS_VALUE is not None
    else None
)
EMBEDDING_DIMENSIONS = EMBEDDING_DIMENSIONS_OVERRIDE or DEFAULT_EMBEDDING_DIMENSIONS
EMBEDDING_PROVIDER = (
    _env_str("OTS_EMBEDDING_PROVIDER", DEFAULT_EMBEDDING_PROVIDER)
